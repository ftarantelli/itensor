...
set xlabel "h L / {/Symbol D}_L" offset 0, 0.4
#set xlabel "{/Symbol=25 k}"
#set xlabel 'w' offset 0,0.8
set ylabel "M / M_0" offset 1.4, 0		# L^{/Arial=20 y_{/Symbol f}}
...
set label 3 at graph 0.78, graph 0.16 "{/Arial=30 {/Symbol Q}_{/ZapfDingbats=15 \110} = 2}" tc lt 8
#set label 1 at graph 0.78, graph 0.22 "{/Arial=30 h_i = {/Arial=28 -0.05}}" tc lt 8
set label 2 at graph 0.78, graph 0.06 "{/Arial=30 {/Symbol U} = 1/2}" tc lt 8


dataf2 = "fotY5T2l12.datt"
dataf3 = "fotY5T2l14.datt"

dataf1 = sprintf("%s", ARG1)
if(ARG1) {dataf1 = "newkzu5s2l14.dat";}


dataf2 = sprintf("%s", ARG2);

dataf3 = sprintf("%s", ARG3);



plot  "spinfermdissN8.dat" using ($1):($2) t 'mps' w l lw 5. lt rgb 'red' dt 6,\
      "spinfermdissN10.dat" using ($1):($2) t 'N = 10' w l lw 5. lt 6 dt 4,\
#      "couplingN8k1j1.dat" using ($1):($3) t 'L = 12' w l lw 5. lt rgb 'blue' dt 5,\
#      "couplingN8k1j1.dat" using ($1):($2) t '50mps' w l lw 5. lt rgb 'black' dt 2,\
