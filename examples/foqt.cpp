...
int main(int argc, char *argv[]) {
	...
	double dt(0.003);//, ds(0.02);
	g = 1.; hi = 0.5; hf = 0.;// tau = 100;
	double upsilon = 0.1, sigma = -5., sigmaf = 1.;	// , omega = 1.
	char folder[10] = "data";
