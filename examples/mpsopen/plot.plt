...
plot  "isdisN6.dat" using ($1):($2) t 'mps' w l lw 2. lt rgb 'black' dt 1,\
      "quenchL6.dat" using ($1):($2) t 'quench' w l lw 4. lt rgb 'red' dt 5,\
      "dissipationL6.dat" using ($1):($2) t 'diss' w l lw 4. lt rgb 'dark-green' dt 2,\
