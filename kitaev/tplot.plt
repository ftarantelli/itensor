...
set xlabel "{/Symbol S}" offset 0, 0.4
#set xlabel "{/Symbol=25 k}"
#set xlabel 'w' offset 0,0.8
#set ylabel "L^{y_{/Symbol \152}} M" offset 1.4, 0		# L^{/Arial=20 y_{/Symbol f}}
#set ylabel "{/Times=50 A}" offset 0.8,0
...
#set label 3 at graph 0.78, graph 0.16 "{/Arial=30 {/Symbol S}_i = -1.5}" tc lt 8
#set label 1 at graph 0.78, graph 0.22 "{/Arial=30 h_i = {/Arial=28 -0.05}}" tc lt 8
set label 2 at graph 0.78, graph 0.06 "{/Arial=30 {/Symbol U} = 0.001}" tc lt 8

plot  "Swireu1k70f80l50.dat1" using ($1):($2*8**(0.)) t 'M_x' w l lw 5. lt 7 dt 6,\
      "Swireu1k70f80l50.dat2" using ($1):($2*8**(0.)) t '' w l lw 5. lt 7 dt 6,\
#      "Swireu0k150f151l50.dat1" using ($1):($4*8**(0.)) t 'M_z' w l lw 5. lt 8 dt 6,\
#      "Swireu0k150f151l50.dat2" using ($1):($2*8**(0.)) t '' w l lw 5. lt 8 dt 6,\

#      "isC2DeS150l150.dat" using ($1):(($2)*150.**(1/8.)) t 'L = 150' w l lw 3. lt 8 dt 1,\
