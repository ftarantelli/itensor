...
set ylabel "{/Times=40 E - E_o}" offset 2.,0
...
set label 3 at graph 0.75, graph 0.15 "{/Arial=30 L = 2000}" tc lt 8
set label 2 at graph 0.75, graph 0.25 "{/Arial=30 {/Symbol U} = 0.001}" tc lt 8

#plot  "wireABCu10k1l50.dat1" using ($1):($7*50.**(0.)) t 'L = 50  ' w l lw 5. lt 8 dt 7,\

#plot   "wireABCu0k200l200.dat1" using ($1):($7*200.**(0.)) t 'L = 200' w l lw 5. lt rgb 'dark-green' dt 1,\
#	"wireABCu0k200l200.dat2" using ($1):($7*200.**(0.)) t '' w l lw 4. lt rgb 'dark-green' dt '.',\
#     "wireABCu0k200l400.dat1" using ($1):($7*400.**(0.)) t 'L = 400' w l lw 4. lt rgb 'blue' dt 1,\
#	"wireABCu0k200l400.dat2" using ($1):($7*400.**(0.)) t '' w l lw 4. lt rgb 'blue' dt '.',\
#      "wireABCu0k200l2000.dat1" using ($1):($7*600.**(0.)) t 'L = 600' w l lw 5. lt 7 dt 1,\
#      "wireABCu0k200l2000.dat2" using ($1):($7*600.**(0.)) t '' w l lw 4. lt 7 dt '.',\

#plot      "wireABCu0k8l2000.dat1" using ($1):($7*800.**(0.)) t '{/Symbol S} = 8    ' w l lw 4. lt 1 dt 1,\
#      "wireABCu0k8l2000.dat2" using ($1):($7*800.**(0.)) t '' w l lw 4. lt 1 dt '.',\

plot      "wireABCu0k20l2000.dat1" using ($1):($7*1000.**(0.)) t '{/Symbol S} = 20  ' w l lw 4. lt 1 dt 1,\
      "wireABCu0k20l2000.dat2" using ($1):($7*1000.**(0.)) t '' w l lw 4. lt 1 dt '.',\
      "wireABCu0k40l2000.dat1" using ($1):($7*2000.**(0.)) t '{/Symbol S} = 40  ' w l lw 4. lt rgb 'blue' dt 1,\
      "wireABCu0k40l2000.dat2" using ($1):($7*2000.**(0.)) t '' w l lw 4. lt rgb 'blue' dt '.',\
      "wireABCu0k80l2000.dat1" using ($1):($7*4000.**(0.)) t '{/Symbol S} = 80  ' w l lw 4. lt 7 dt 1,\
      "wireABCu0k80l2000.dat2" using ($1):($7*4000.**(0.)) t '' w l lw 4. lt 7 dt '.',\
      "wireABCu0k100l2000.dat1" using ($1):($7*600.**(0.)) t '{/Symbol S} = 100' w l lw 5. lt rgb 'dark-green' dt 1,\
      "wireABCu0k100l2000.dat2" using ($1):($7*600.**(0.)) t '' w l lw 4. lt rgb 'dark-green' dt '.',\
      "wireABCu0k140l2000.dat1" using ($1):($7*600.**(0.)) t '{/Symbol S} = 140' w l lw 5. lt 8 dt 1,\
      "wireABCu0k140l2000.dat2" using ($1):($7*600.**(0.)) t '' w l lw 4. lt 8 dt '.',\
#      "wireABCu0k200l20000.dat1" using ($1):(log(1-$7)*10000.**(0.)) t 'L = 10000' w l lw 4. lt 8 dt 1,\
#      "wireABCu1k20l400.dat1" using ($1):($7*400.**(0.)) t 'C@^o_{L/3}' w l lw 5. lt 1 dt 1,\
#      "wireABCu1k20l400.dat1" using ($1):($7*400.**(0.)) t '' w l lw 4. lt 1 dt '.',\
#      "wireABCu0k200l20000.dat1" using ($1/500):(log(1-$7)*500.**(0.)) t 'L = 12' w l lw 5. lt 7 dt 7,\
#      "data/kzUp1Sig-1L12p1A2.dat1" using ($1/12):(log(1-$7)*4.**(0.)) t 'L = 12' w l lw 5. lt 8 dt 7,\
#      "data/tPyL8g1.dat1" using ($1):($7) t 'L=4' pt 7 ps 0.8 lt 7,\
#      "data/CtL6g1.dat1" using ($1):($7) t 'L=4' w l lw 5. lt rgb 'blue' dt 1 ,\
#do for [N=1:5] {
#plot func(N, x)
#pause -1
#}
