...
set ylabel "A^{/Roman (a)}" offset 1.4, 0;
...
#plot  "wireABCu10k1l50.dat1" using ($1):(exp(-$4)*50.**(0.)) t 'L = 50  ' w l lw 5. lt 8 dt 7,\

#plot   "wireABCu0k200l200.dat1" using ($1):(exp(-$4)*200.**(0.)) t 'L = 200' w l lw 5. lt rgb 'dark-green' dt 1,\
#	"wireABCu0k200l200.dat1" using ($1):(exp(-$4)*200.**(0.)) t '' w l lw 4. lt rgb 'dark-green' dt '.',\
#     "wireABCu0k200l400.dat1" using ($1):(exp(-$4)*400.**(0.)) t 'L = 400' w l lw 4. lt rgb 'blue' dt 1,\
#	"wireABCu0k200l400.dat1" using ($1):(exp(-$4)*400.**(0.)) t '' w l lw 4. lt rgb 'blue' dt '.',\
#      "wireABCu0k200l2000.dat1" using ($1):(exp(-$4)*600.**(0.)) t 'L = 600' w l lw 5. lt 7 dt 1,\
#      "wireABCu0k200l2000.dat1" using ($1):(exp(-$4)*600.**(0.)) t '' w l lw 4. lt 7 dt '.',\

#plot      "wireABCu0k8l2000.dat1" using ($1):(exp(-$4)*800.**(0.)) t '{/Symbol Q}_{/ZapfDingbats=15 \110} = 8    ' w l lw 4. lt 1 dt 1,\
#      "wireABCu0k8l2000.dat1" using ($1):(exp(-$4)*800.**(0.)) t '' w l lw 4. lt 1 dt '.',\

set label 1 at graph 0.05, graph 0.4 "{/Arial=30 L = 2000}" tc lt 8

set label 2 at graph 0.05, graph 0.18 "{/Arial=30 {/Symbol U} =  0.001}" tc lt 8


plot      "wireABCu0k20l2000.dat1" using ($1):(exp(-$4)*1000.**(0.)) t '{/Symbol Q}_{/ZapfDingbats=15 \110} = 20  ' w l lw 5. lt rgb 'blue' dt '.',\
      "wireABCu0k20l2000.ddat2" using ($1):(exp(-$4)*1000.**(0.)) t '' w l lw 4. lt 1 dt '.',\
      "wireABCu0k40l2000.dat1" using ($1):(exp(-$4)*2000.**(0.)) t '{/Symbol Q}_{/ZapfDingbats=15 \110} = 40  ' w l lw 5. lt rgb 'grey' dt 4,\
      "wireABCu0k40l2000.ddat2" using ($1):(exp(-$4)*2000.**(0.)) t '' w l lw 4. lt rgb 'blue' dt '.',\
      "wireABCu0k80l2000.dat1" using ($1):(exp(-$4)*4000.**(0.)) t '{/Symbol Q}_{/ZapfDingbats=15 \110} = 80  ' w l lw 5. lt 7 dt 5,\
      "wireABCu0k80l2000.ddat2" using ($1):(exp(-$4)*4000.**(0.)) t '' w l lw 4. lt 7 dt '.',\
      "wireABCu0k100l2000.dat1" using ($1):(exp(-$4)*600.**(0.)) t '{/Symbol Q}_{/ZapfDingbats=15 \110} = 100' w l lw 5. lt 1 dt 6,\
      "wireABCu0k100l2000.ddat2" using ($1):(exp(-$4)*600.**(0.)) t '' w l lw 4. lt rgb 'dark-green' dt '.',\
      "wireABCu0k140l2000.dat1" using ($1):(exp(-$4)*600.**(0.)) t '{/Symbol Q}_{/ZapfDingbats=15 \110} = 140' w l lw 2.5 lt 8 dt 1,\
      "wireABCu0k140l2000.ddat2" using ($1):(exp(-$4)*600.**(0.)) t '' w l lw 4. lt 8 dt '.',\
...
set xlabel "{/Symbol Q}" offset 0, 0.4
set ylabel "A^{/Roman (b)}" offset 1.4, 0;


plot      "wireABCu0k20l2000.dat2" using ($1):(exp(-$4)*1000.**(0.)) t '{/Symbol Q}_{/ZapfDingbats=15 \110} = 20  ' w l lw 4. lt rgb 'blue' dt '.',\
      "wireABCu0k20l2000.ddat2" using ($1):(exp(-$4)*1000.**(0.)) t '' w l lw 4. lt 1 dt '.',\
      "wireABCu0k40l2000.dat2" using ($1):(exp(-$4)*2000.**(0.)) t '{/Symbol Q}_{/ZapfDingbats=15 \110} = 40  ' w l lw 4. lt rgb 'grey' dt 4,\
      "wireABCu0k40l2000.ddat2" using ($1):(exp(-$4)*2000.**(0.)) t '' w l lw 4. lt rgb 'blue' dt '.',\
      "wireABCu0k80l2000.dat2" using ($1):(exp(-$4)*4000.**(0.)) t '{/Symbol Q}_{/ZapfDingbats=15 \110} = 80  ' w l lw 4. lt 7 dt 5,\
      "wireABCu0k80l2000.ddat2" using ($1):(exp(-$4)*4000.**(0.)) t '' w l lw 4. lt 7 dt '.',\
      "wireABCu0k100l2000.dat2" using ($1):(exp(-$4)*600.**(0.)) t '{/Symbol Q}_{/ZapfDingbats=15 \110} = 100' w l lw 4. lt 1 dt 6,\
      "wireABCu0k100l2000.ddat2" using ($1):(exp(-$4)*600.**(0.)) t '' w l lw 4. lt rgb 'dark-green' dt '.',\
      "wireABCu0k140l2000.dat2" using ($1):(exp(-$4)*600.**(0.)) t '{/Symbol Q}_{/ZapfDingbats=15 \110} = 140' w l lw 4 lt 8 dt 1,\
      "wireABCu0k140l2000.ddat2" using ($1):(exp(-$4)*600.**(0.)) t '' w l lw 4. lt 8 dt '.',\
